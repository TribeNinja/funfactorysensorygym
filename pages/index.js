...
function blog({ blogs }) {
  ...
  return (
    <div>
      <Head>
        <title>Custom Sensory Gym | Sensory Gym Blog | Professional Insight</title>
        <meta
          name="description"
              ...
              <div key={blog._id}>
                <div className="flex items-center md:space-x-14">
                        ...
                        <a>
                          <Slider {...settings}>
                            {blog.gallery.map((image) => (
                              <div className="w-full h-80 relative my-6" key={i}>
                  ...
                  <div className="w-full md:w-3/5">
                    <h1 className="text-2xl md:text-3xl font-semibold md:leading-normal">{blog.title}</h1>
