    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-0">
        <div className="mt-40 lg:mt-36 xl:mt-40 items-center px-6 lg:px-14">
          <div className="space-y-6 lg:space-y-8 xl:max-w-lg">
            ...
            <p className="leading-relaxed">
              At Fun Factory Sensory Gym, we design, manufacture, and custom-install sensory gyms throughout the United
              States. From learning about your space, the design of your sensory gym, and the 3-D rendering of your
              space, where you can see what your gym would look like at your provided location, to the installation of
              our custom products, our design specialists will create the most effective and efficient sensory gym for
              all your needs. At Fun Factory Sensory Gym, our mission is to impact the lives of children through
              developmental and therapeutic sensory play. If you are a parent, therapist, or organization looking for a
              fun, healthy way for your children to learn, develop, and grow; book a free consultation with our design
              team today to learn more about Fun Factory and your dream sensory gym.
            </p>
            <div className="flex items-center space-x-3">
              ...
              <p className="font-medium leading-relaxed flex">
                A percentage of every installation is given back to families with special needs.
              </p>
            </div>
          </div>
        ...
        <div className="relative">
          <Slider {...settings}>
            <video className="h-[35rem] md:h-[96vh] w-full object-cover" autoPlay playsInline loop muted>
            ...
            <div className="flex items-center justify-between px-6 py-4 bg-white">
                ...
                <div>
                  <div className="font-bold text-2xl">
                    <VisibilitySensor partialVisibility>
                      {({ isVisible }) => <p>{isVisible ? <CountUp start={1} end={550000} duration={3} /> : null}+</p>}
                    </VisibilitySensor>
                  </div>
              ...
              <div className="flex items-center space-x-4">
                <div>
                  <div className="font-bold text-2xl">
                    <VisibilitySensor partialVisibility>
                      {({ isVisible }) => <p>{isVisible ? <CountUp start={1} end={4400} duration={3} /> : null}+</p>}
                    </VisibilitySensor>
                  </div>
